 ...
 *
 */
void bp_sw_init_random(void);
#define init_random bp_sw_init_random
 ...
 *
 */
int bp_sw_random_integer(int l);
#define random_integer bp_sw_random_integer
 ...
 *
 */
double bp_sw_random_0_to_1(void);
#define random_0_to_1 bp_sw_random_0_to_1
